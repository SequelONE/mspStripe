...
Ext.extend(mspStripe.grid.Items, MODx.grid.Grid, {
    windows: {},
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = mspStripe.utils.getMenu(row.data['actions'], this, ids);
    ...
    getColumns: function () {
        return [{
            ...
            dataIndex: 'active',
            renderer: mspStripe.utils.renderBoolean,
            sortable: true,
            width: 100,
        }, {
            header: _('mspstripe_grid_actions'),
            dataIndex: 'actions',
            renderer: mspStripe.utils.renderActions,
            sortable: false,
            width: 100,
            id: 'actions'
        }];
    ...
    getTopBar: function () {
        return [{
            text: '<i class="icon icon-plus"></i>&nbsp;' + _('mspstripe_item_create'),
            handler: this.createItem,
            scope: this
        }, '->', {
            xtype: 'mspstripe-field-search',
            width: 250,
            listeners: {
                search: {
                    fn: function (field) {
