...
class mspStripeOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('mspstripe_item_err_ns');
        }
...
return 'mspStripeOfficeItemUpdateProcessor';
